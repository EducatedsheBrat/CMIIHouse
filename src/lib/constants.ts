...
export const HOUSES: Record<HouseId, HouseMeta> = {
  lumina: {
    ...
    name: 'Lumina',
    motto: 'Vision & Light',
    description: 'Latin for light. Lumina sees what others miss and lights the path for everyone who follows.',
    color: '#D4A843',
    icon: 'sun',
  ...
  doron: {
    ...
    name: 'Doron',
    motto: 'Gifts & Talents',
    description: 'Greek for gift. Doron believes every member carries a talent worth sharing with the world.',
    color: '#5B8DBE',
    icon: 'diamond',
  ...
  ase: {
    ...
    description: 'Yoruba for the power to make things happen. Asé turns imagination into work that moves people.',
    color: '#9B6BA3',
    icon: 'star',
  ...
  kaizen: {
    ...
    description: 'Japanese for change for the better. Kaizen grows a little every day and never stops leveling up.',
    color: '#6AAB6E',
    icon: 'triangle',
